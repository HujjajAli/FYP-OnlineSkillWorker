						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-globe fa"
									aria-hidden="true"></i></span> <button class="form-control" id="workerAddress">Set My Location</button>
							</div>
						</div>
					</div>
				<form class="form-horizontal" method="post"
					action="RegistrationController">
					<input type="hidden" name="act" value="workerRegistration">
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-user fa"
									...
									name="worker" id="name" placeholder="Enter your Name" />
							</div>
						</div>
					</div>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-phone fa"
									aria-hidden="true"></i></span> <input type="text" class="form-control"
									name="phone" id="address" placeholder="Enter your Phone #" />
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<label for="area" class="cols-sm-2 control-label">Area/Shop Address</label>
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-globe fa"
